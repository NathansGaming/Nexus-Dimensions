...
public final class MobCustomizationListener implements Listener {
    ...
    private void applyProfile(Entity entity, DimensionPreset.MobProfile profile) {
        ...
        if (profile.scale != 1.0) {
            // Attribute.SCALE - added in 1.20.5 (GENERIC_ prefix dropped from all
            // Attribute constants as of the 1.21 API bump). See README's
            // uncertain-API list; if this doesn't resolve, delete this one call
