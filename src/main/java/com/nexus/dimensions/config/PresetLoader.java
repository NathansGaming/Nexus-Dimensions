            ...
            if (mobsSec != null) {
                ...
                for (Object typeKey : mobsSec.getKeys(false)) {
                    ...
                    if (mobSec != null) {
                        ...
                        ConfigurationSection equipmentSec = mobSec.getConfigurationSection("equipment");
                        if (equipmentSec != null) {
                            LinkedHashMap<String, String> equipment = new LinkedHashMap<String, String>();
                            for (String slot : equipmentSec.getKeys(false)) {
                                equipment.put(slot.toLowerCase(Locale.ROOT), equipmentSec.getString(slot));
                            }
